...
function campaignToFormData(campaign: Campaign): CampaignFormData {
  ...
  return {
    ...
    budget_fixed: campaign.budget_type === 'fixed' && campaign.budget_max != null ? String(campaign.budget_max) : '',
    budget_min: campaign.budget_type === 'range' && campaign.budget_min != null ? String(campaign.budget_min) : '',
    budget_max: campaign.budget_type === 'range' && campaign.budget_max != null ? String(campaign.budget_max) : '',
